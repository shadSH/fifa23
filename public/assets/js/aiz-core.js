...
(function ($) {
    ...
    AIZ.data = {
        ...
        route_dir: $('meta[name="route_dir"]').attr("content")
    };
    AIZ.uploader = {
        data: {
            selectedFiles: [],
                ...
                if (data.length > 0) {
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (data[i].type === "image") {
                            ...
                            thumb = '<i class="fas fa-file-alt fa-5x"></i>';
                        }
                        var html =
                            ...
                            "</div>" +
                            '<div class="card-body">' +
                            '<h6 class="d-flex" style="color: blue; font-size: 34px">' +
                        ...
                        if (data.length > 0) {
                            ...
                            for (
                                ...
                                if (data[i].type === "image") {
                                    ...
                                    thumb = '<i class="fas fa-file-alt"></i>';
                                }
                                var html =
                                    '<div class="d-flex justify-content-between align-items-center mt-2 file-preview-item text-danger" data-id="' +
                                    data[i].id +
                                    '" title="' +
                                    data[i].file_original_name +
                                    "." +
