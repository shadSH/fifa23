<div id="modal_form_vertical_reply" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
                        ...
                        <div class="card">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-top py-0">
                                            <div class="d-sm-flex flex-sm-wrap">
                                                <input type="text" value="{{$contact->email}}"  class="form-control h-auto flex-fill w-auto py-2 px-0 border-0 rounded-0" placeholder="Add recipients" disabled>
                                                <input type="hidden" value="{{$contact->email}}" name="to">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="align-top py-0">
                                            <input type="text" value="REPLY-{{$contact->subject}}" class="form-control h-auto py-2 px-0 border-0 rounded-0" placeholder="Add subject"
                                                   disabled>
                                            <input type="hidden" value="REPLY-{{$contact->subject}}" name="subject" class="form-control h-auto py-2 px-0 border-0 rounded-0" placeholder="Add subject">
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="card-body p-0">
                                <div class="overflow-auto mw-100">
                                   <textarea name="message" id="editor-full-reply" rows="4" cols="4">
                                       <br>
                                        <br>
                                       <p>---------------REPLY----------------</p>
                                        {{$contact->message}}
...
<!-- /vertical form modal -->
    ...
    <script>
        $(document).ready(function () {
            CKEDITOR.replace('editor-full-reply', {
                height: 400
            });
        })
    </script>
